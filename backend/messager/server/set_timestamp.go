...
func (s *Server) SetReceived(ctx context.Context, in *pbmessager.UpdateStatusRequest) (*emptypb.Empty, error) {
...
func (s *Server) SetSeen(ctx context.Context, in *pbmessager.UpdateStatusRequest) (*emptypb.Empty, error) {
	if err := in.Validate(); err != nil {
		return nil, err
	}
	db, err := ConnDB()
...
func (s *Server) setTimestamp(ctx context.Context, db *sqlx.DB, userId uint64, in *pbmessager.UpdateStatusRequest, setterFunc func(*ent.Message) *ent.Message) (*emptypb.Empty, error) {
