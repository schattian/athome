...
func (s *Server) Retrieve(ctx context.Context, in *pbmessager.RetrieveRequest) (*pbmessager.Message, error) {
...
func (s *Server) retrieve(ctx context.Context, db *sqlx.DB, userId uint64, in *pbmessager.RetrieveRequest) (*pbmessager.Message, error) {
